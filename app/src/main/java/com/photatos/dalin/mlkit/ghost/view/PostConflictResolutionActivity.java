...
public class PostConflictResolutionActivity extends BaseActivity implements View.OnClickListener {
    ...
    @BindView(R.id.conflict_explanation)
    TextView mExplanationView;
    @BindView(R.id.conflict_choice)
    RadioGroup mChoiceGroup;
    @BindView(R.id.conflict_choice_use_device_copy)
    RadioButton mChoiceUseDeviceCopyBtn;
    @BindView(R.id.conflict_choice_use_server_copy)
    RadioButton mChoiceUseServerCopyBtn;
//    @BindView(R.id.conflict_decide_later_btn)           View mDecideLaterBtn;
    @BindView(R.id.conflict_accept_btn)
View mAcceptBtn;

    @BindView(R.id.conflict_post_preview_status)
    TextView mPostPreviewStatusView;
    @BindView(R.id.conflict_post_preview_title)
    TextView mPostPreviewTitleView;
    @BindView(R.id.conflict_post_preview_markdown)
    TextView mPostPreviewMarkdownView;
