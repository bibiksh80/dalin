...
import com.photatos.dalin.mlkit.md.java.Utils;
...
public class SearchedObjectCloud {
  ...
  public SearchedObjectCloud(Resources resources, DetectedObject object, List<Product> productList) {
    this.object = object;
