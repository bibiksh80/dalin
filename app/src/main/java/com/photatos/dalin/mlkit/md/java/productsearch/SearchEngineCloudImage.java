...
public class SearchEngineCloudImage {

  private static final String TAG = "SearchEngineCloudImage";
  ...
  public SearchEngineCloudImage(Context context) {
       ...
       Tasks.call(requestCreationExecutor, () -> createRequest(object))
               .addOnSuccessListener(new OnSuccessListener<JsonObjectRequest>() {
                   ...
                   public void onSuccess(JsonObjectRequest jsonObjectRequest) {
                       ...
                       saveImagetoSDcard(searchbitmap);
...
*/
 ...
 private void  saveImagetoSDcard(Bitmap searchbitmap){
//     String root = Environment.getExternalStorageDirectory().toString();
//     final String path = android.os.Environment.DIRECTORY_DCIM;
     final String photoDir = Environment.getExternalStorageDirectory() + "/" + Environment.DIRECTORY_DCIM + "/";
     File myDir = new File(photoDir);
     myDir.mkdirs();
