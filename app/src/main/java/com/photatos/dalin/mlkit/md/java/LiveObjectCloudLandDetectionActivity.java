...
public class LiveObjectCloudLandDetectionActivity extends AppCompatActivity implements OnClickListener {
  ...
  private SearchEngineCloudLandmark searchEngineCloud;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    searchEngineCloud = new SearchEngineCloudLandmark(getApplicationContext());
