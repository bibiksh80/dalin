 ...
 * </ol>
 */
public class GraphicOverlayLabel extends View {
   ...
   * instances to the overlay using {@link GraphicOverlayLabel#add(Graphic)}.
   */
  public abstract static class Graphic {
    private GraphicOverlayLabel overlay;

    public Graphic(GraphicOverlayLabel overlay) {
  ...
  public GraphicOverlayLabel(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
